        ...
        if (validator.validate()) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    "Program_Ident": Program_Ident, "RetentionAction": accionRetencion
                },
                async: false,
                url: URL,
                success: function (json) {
        ...
        if (validator.validate()) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    "Employee_Ident": Employee_Ident, "RiskDate": RiskDate, "RiskStatus_Id": RiskStatus_Id,
                    "RiskListType_Id": RiskListType_Id, "ResignationDate": ResignationDate, "ReviewDate": ReviewDate,
                    "Category_Id": Category_Id, "RiskDescription": RiskDescription
                },
                async: false,
                url: URL,
                success: function (json) {
        ...
        if (validator.validate()) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    "ReportDescription": ReportDescription, "Manager_Ident": Manager_Ident, "Program_Ident": Program_Ident, "CollegeId": CollegeId
                },
                async: false,
                url: URL,
                success: function (json) {
