var HRReports = {
    ...
    Search_HRReports_Details: function () {
        ...
        if (result == true) {
            ...
            if ($('#cbHRreport_Id').is(":checked")) {
                HRreport_Id = $("#HRreport_Id").val();
                checkBoxesChecked = true;
                if (!HRreport_Id) {
                    toast('Must type a Folio user for filter results', 4000, 'rounded yellow darken-2');
                    result = false;
                }
            }
